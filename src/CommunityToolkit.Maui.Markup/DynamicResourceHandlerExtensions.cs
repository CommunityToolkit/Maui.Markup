...
public static class DynamicResourceHandlerExtensions
{
	...
	/// <returns>Layout with added Dynamic Resource</returns>
	public static TDynamicResourceHandler DynamicResources<TDynamicResourceHandler>(this TDynamicResourceHandler dynamicResourceHandler, params (BindableProperty property, string key)[] resources)
		where TDynamicResourceHandler : IDynamicResourceHandler
	{
