...
/// <summary>
/// An <see cref="IValueConverter" /> implementation that provides the ability to define type safe <see cref="Func" /> implementations that will be used in the conversion process.
/// </summary>
...
public class FuncConverter<TSource, TDest, TParam> : IValueConverter
{
	...
	/// <summary>
	/// Initializes a new instance of <see cref="FuncConverter" /> that allows support for acessing the <c>parameter</c> and <see cref="CultureInfo" /> in the conversion.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of <see cref="FuncConverter" /> that allows support for acessing the <c>parameter</c> in the conversion.
	/// </summary>
...
/// <summary>
/// An <see cref="IValueConverter" /> implementation that performs a <see cref="ToString()" /> on the incoming value.
/// </summary>
public class ToStringConverter : FuncConverter<object, string>
{
	...
	/// </summary>
	/// <param name="format">The format to apply when performing the <see cref="ToString()" /> method call.</param>
