...
public class Style<T> where T : BindableObject
{
	...
	public Style(params List<(BindableProperty Property, object Value)> setters)
	{
	...
	/// <param name="setters"></param>
	/// <returns>Style with added setters</returns>
	public Style<T> Add(params List<(BindableProperty Property, object Value)> setters)
	{
	...
	/// <returns>Style with added setters</returns>
	public Style<T> AddAppThemeBindings(params List<(BindableProperty Property, object Light, object Dark)> setters)
	{
	...
	public Style<T> Add(params List<Behavior> behaviors)
	{
	...
	public Style<T> Add(params List<TriggerBase> triggers)
	{
