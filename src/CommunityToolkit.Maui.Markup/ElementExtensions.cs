...
public static class ElementExtensions
{
	...
	public static TBindable RemoveDynamicResources<TBindable>(this TBindable bindable, params List<BindableProperty> properties) where TBindable : BindableObject
	{
	...
	public static TElement Effects<TElement>(this TElement element, params List<Effect> effects) where TElement : Element
	{
