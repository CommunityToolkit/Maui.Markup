...
namespace CommunityToolkit.Maui.Markup.UnitTests
{
    ...
    {
        readonly static IReadOnlyList<Element> testData = new Element[]
        {
            new Label(),
            new Span(),
        };
        ...
        public void BindClickGestureDefaults(TGestureElement gestureElement)
        {
        ...
        [Theory]
        [MemberData(nameof(testData))]
        public void BindClickGesturePositionalParameters(TGestureElement gestureElement)
        {
        ...
        [Theory]
        [MemberData(nameof(testData))]
        public void BindTapGestureDefaults(TGestureElement gestureElement)
        {
        ...
        [Theory]
        [MemberData(nameof(testData))]
        public void BindTapGesturePositionalParameters(TGestureElement gestureElement)
        {
            object commandSource = new ViewModel();
            object parameterSource = new ViewModel();
        ...
        [Theory]
        [MemberData(nameof(testData))]
        public void ClickGesture(TGestureElement gestureElement)
        {
        ...
        [Theory]
        [MemberData(nameof(testData))]
        public void TapGesture(TGestureElement gestureElement)
        {
    ...
    public class ElementGesturesExtensionsTests : ElementGesturesBaseTestFixture
    {
        ...
        {
            Assert.IsAssignableFrom<DerivedFromLabel>(
        ...
        {
            Assert.IsAssignableFrom<DerivedFromSpan>(
                new DerivedFromSpan()
                .Gesture((TapGestureRecognizer g) => g.Bind(nameof(ViewModel.Command))));
        }
    }

    public class ElementGesturesBaseTestFixture : MarkupBaseTest
    {
            ...
            where TGestureRecognizer : GestureRecognizer
        {
            ...
            Assert.Equal(gestureRecognizers.Length, count);

            foreach (var gestureRecognizer in gestureRecognizers)
                Assert.Equal(1, element?.GestureRecognizers?.Count(g => ReferenceEquals(g, gestureRecognizer)) ?? 0);
