...
class PaddingElementExtensionsTests : BaseMarkupTestFixture
{
	...
	[
		...
		new("ContentPresenter", () => new ContentPresenter(), ContentPresenter.PaddingProperty, (bindable, padding) => ((ContentPresenter)bindable).Padding(padding), (bindable, uniformSize) => ((ContentPresenter)bindable).Padding(uniformSize), (bindable, horizontal, vertical) => ((ContentPresenter)bindable).Padding(horizontal, vertical), (bindable, left, top, right, bottom) => ((ContentPresenter)bindable).Paddings(left, top, right, bottom)),
		...
		new("Layout", () => new Grid(), Layout.PaddingProperty, (bindable, padding) => ((Grid)bindable).Padding(padding), (bindable, uniformSize) => ((Grid)bindable).Padding(uniformSize), (bindable, horizontal, vertical) => ((Grid)bindable).Padding(horizontal, vertical), (bindable, left, top, right, bottom) => ((Grid)bindable).Paddings(left, top, right, bottom)),
		...
		new("TemplatedView", () => new ContentView(), TemplatedView.PaddingProperty, (bindable, padding) => ((ContentView)bindable).Padding(padding), (bindable, uniformSize) => ((ContentView)bindable).Padding(uniformSize), (bindable, horizontal, vertical) => ((ContentView)bindable).Padding(horizontal, vertical), (bindable, left, top, right, bottom) => ((ContentView)bindable).Paddings(left, top, right, bottom))
	];
