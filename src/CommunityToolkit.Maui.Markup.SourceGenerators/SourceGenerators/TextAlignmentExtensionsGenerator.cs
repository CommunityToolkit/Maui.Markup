...
namespace CommunityToolkit.Maui.Markup
{
    ...
    {{textAlignmentClassMetadata.ClassAcessModifier}} static partial class TextAlignmentExtensions_{{textAlignmentClassMetadata.ClassName}}
    {
        ...
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.Start"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextStart{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
        {
        ...
        /// </summary>
        /// <param name="textAlignmentControl"></param>
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.Center"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextCenterHorizontal{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
        {
            ArgumentNullException.ThrowIfNull(textAlignmentControl);
        ...
        /// </summary>
        /// <param name="textAlignmentControl"></param>
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.End"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextEnd{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
        {
            ArgumentNullException.ThrowIfNull(textAlignmentControl);
        ...
        /// <param name="textAlignmentControl"></param>
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.Start"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextTop{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
        {
            ArgumentNullException.ThrowIfNull(textAlignmentControl);
        ...
        /// <param name="textAlignmentControl"></param>
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.Center"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextCenterVertical{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
        {
            ArgumentNullException.ThrowIfNull(textAlignmentControl);
        ...
        /// <param name="textAlignmentControl"></param>
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.End"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextBottom{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
        {
            ArgumentNullException.ThrowIfNull(textAlignmentControl);
        ...
        /// <param name="textAlignmentControl"></param>
        /// <returns><paramref name="textAlignmentControl"/> with added <see cref="TextAlignment.Center"/></returns>
        public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextCenter{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
			{{textAlignmentClassMetadata.GenericConstraints}}
    ...
    namespace LeftToRight
    {
        ...
        {{textAlignmentClassMetadata.ClassAcessModifier}} static partial class TextAlignmentExtensions_{{textAlignmentClassMetadata.ClassName}}
        {
            ...
            /// </summary>
            /// <param name="textAlignmentControl"></param>
            /// <returns><paramref name="textAlignmentControl"/> with <see cref="TextAlignment.Start"/></returns>
			public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextLeft{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
				{{textAlignmentClassMetadata.GenericConstraints}}
            {
                ArgumentNullException.ThrowIfNull(textAlignmentControl);
            ...
            /// </summary>
            /// <param name="textAlignmentControl"></param>
            /// <returns><paramref name="textAlignmentControl"/> with <see cref="TextAlignment.End"/></returns>
            public static {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} TextRight{{genericArguments}}(this {{textAlignmentClassMetadata.Namespace}}.{{textAlignmentClassMetadata.ClassName}}{{genericArguments}} textAlignmentControl)
				{{textAlignmentClassMetadata.GenericConstraints}}
            {
                ArgumentNullException.ThrowIfNull(textAlignmentControl);
