	...
	static Grid CreateGrid() => new()
	{
		...
		Children =
		{
			new Label { LineBreakMode = LineBreakMode.TailTruncation, MaxLines = 1 }
				...
				.Top().Padding(10, 0)
				.Bind(Label.TextProperty, nameof(StoryModel.Title), (StoryModel m) => m.Title, mode: BindingMode.OneTime)
			...
			new Label().Row(Row.Description)
				...
				.Paddings(10, 0, 10, 5)
				.Bind(Label.TextProperty, nameof(StoryModel.Description), (StoryModel m) => m.Description, mode: BindingMode.OneTime)
