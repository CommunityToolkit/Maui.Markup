		...
		Content = new AbsoluteLayout
		{
			Children =
			{
				...
				new Entry { Keyboard = Keyboard.Numeric, BackgroundColor = Colors.White }
					...
					.Bind(Entry.TextProperty, nameof(SettingsViewModel.NumberOfTopStoriesToFetch), (SettingsViewModel vm) => vm.NumberOfTopStoriesToFetch, (SettingsViewModel vm, int text) => vm.NumberOfTopStoriesToFetch = text)
					.TextCenter()
